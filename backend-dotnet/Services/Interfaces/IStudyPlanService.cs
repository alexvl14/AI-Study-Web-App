...
namespace backend_dotnet.Services.Interfaces
{
	public interface IStudyPlanService
	{
		...
		public Task<StudyPlanResponse> GetStudyPlanAsync(string userId, int notebookId, int studyPlanId, int secondsSpent);
		public Task UpdateTimeSpendAsync(string userId, int notebookId, int studyPlanId, int secondsSpent);
